...
<entity:animania:doe_angora>.setAspects(<aspect:bestia>*4, <aspect:terra>*2, <aspect:victus>*2, <aspect:pannus>*2);
...
// Bucks - Male Goats
<entity:animania:buck_alpine>.setAspects(<aspect:bestia>*5, <aspect:terra>*2, <aspect:victus>*2, <aspect:ira>*1);
<entity:animania:buck_angora>.setAspects(<aspect:bestia>*5, <aspect:terra>*2, <aspect:victus>*2, <aspect:pannus>*2, <aspect:ira>*1);
<entity:animania:buck_fainting>.setAspects(<aspect:bestia>*5, <aspect:terra>*2, <aspect:victus>*2, <aspect:perditio>*1, <aspect:ira>*1);
<entity:animania:buck_kiko>.setAspects(<aspect:bestia>*5, <aspect:terra>*2, <aspect:victus>*3, <aspect:ira>*1);
<entity:animania:buck_kinder>.setAspects(<aspect:bestia>*5, <aspect:terra>*2, <aspect:victus>*2, <aspect:ira>*1);
<entity:animania:buck_nigerian_dwarf>.setAspects(<aspect:bestia>*4, <aspect:terra>*2, <aspect:victus>*2, <aspect:ira>*1);
<entity:animania:buck_pygmy>.setAspects(<aspect:bestia>*4, <aspect:terra>*2, <aspect:victus>*2, <aspect:ira>*1);

// Kids - Baby Goats
<entity:animania:kid_alpine>.setAspects(<aspect:bestia>*2, <aspect:terra>*1, <aspect:victus>*1);
<entity:animania:kid_angora>.setAspects(<aspect:bestia>*2, <aspect:terra>*1, <aspect:victus>*1, <aspect:pannus>*1);
...
<entity:animania:stallion_draft>.setAspects(<aspect:bestia>*10, <aspect:terra>*3, <aspect:motus>*5, <aspect:potentia>*4, <aspect:ira>*1);

// Foals - Baby Horses
<entity:animania:foal_draft>.setAspects(<aspect:bestia>*4, <aspect:terra>*2, <aspect:motus>*2, <aspect:victus>*2);

// ===== GOAT PRODUCTS =====
// Goat Milk (Already in base, but adding here for completeness)
<animania:goat_milk>.setAspects(<aspect:aqua>*3, <aspect:victus>*2, <aspect:fames>*2);

// Goat Cheese
<animania:goat_cheese>.setAspects(<aspect:fames>*4, <aspect:victus>*2, <aspect:bestia>*1);

// Goat Meat
<animania:raw_chevon>.setAspects(<aspect:bestia>*3, <aspect:victus>*3, <aspect:fames>*3);
<animania:cooked_chevon>.setAspects(<aspect:bestia>*3, <aspect:victus>*2, <aspect:fames>*5, <aspect:ignis>*1);

// Goat Horn
<animania:goat_horn>.setAspects(<aspect:bestia>*2, <aspect:instrumentum>*1, <aspect:sensus>*1);

// Mohair (from Angora goats)
<animania:mohair>.setAspects(<aspect:pannus>*3, <aspect:bestia>*1);
